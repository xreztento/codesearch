...
import org.xreztento.tools.codesearch.backend.crawler.common.debug.StopWatch;
import org.xreztento.tools.codesearch.backend.crawler.common.threads.CodeSearchThreadFactory;
import org.xreztento.tools.codesearch.backend.crawler.common.threads.ExecutorFactory;
import org.xreztento.tools.codesearch.backend.hbase.parallel.ParallelResultScanner;
import org.xreztento.tools.codesearch.backend.hbase.parallel.ScanTaskException;
...
public class HBaseTemplate extends HBaseAccessor implements HBaseOperations, InitializingBean, DisposableBean {
    ...
    public void afterPropertiesSet() {
        ...
        CodeSearchThreadFactory parallelScannerThreadFactory = new CodeSearchThreadFactory("Codesearch-parallel-scanner");
