...
// ---------------------------------------------------------------------------------------------------------------------
        ...
        Grid.mixin({
            ...
            handleSegMouseover: function (seg, ev) {
                if (
                    !GlobalEmitter.get().shouldIgnoreMouse() && !this.mousedOverSeg
                ) {
            ...
            handleSegDblClick: function (seg, ev) {
                this.view.publiclyTrigger('eventDblClick', seg.el[0], seg.event, ev, {}); // last argument is jqui dummy
            },
            //********************************************************
        ...
        function EventManager() { // assumed to be a calendar
            ...
            function fetchEventSources(specificSources, specialFetchType) {
                ...
                for (i = 0; i < specificSources.length; i++) {
                    ...
                    //在提前加载源的情况下，自动获取
                    //********************************************
                    if(source.origArray && source.origArray.length !== source.events.length) {
