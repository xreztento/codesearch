    ...
    !function (t) {
        ...
        function a(e, n, i) {
            ...
            l(e), e.each(function (n, i) {
                ...
                var i = e === o.length - 1 ? s : r, l = a[e], c = u[e], d = i - (l - c);
                l < i && t(n).height(d)
            })
        }
        ...
        function f(t, e) {
            var n = t.offset(), i = p(t), r = n.left + S(t, "border-left-width") + i.left - (e ? e.left : 0), s = n.top + S(t, "border-top-width") + i.top - (e ? e.top : 0);
            return {left: r, right: r + t[0].clientWidth, top: s, bottom: s + t[0].clientHeight}
        }

        function g(t, e) {
            var n = t.offset(), i = n.left + S(t, "border-left-width") + S(t, "padding-left") - (e ? e.left : 0), r = n.top + S(t, "border-top-width") + S(t, "padding-top") - (e ? e.top : 0);
        ...
        function O(t, e) {
            var n, i, r;
            for (n = 0; n < Kt.length && (i = Kt[n], r = V(i, t, e), !(r >= 1 && pt(r))); n++);
            return i
        }
        ...
        function P(t, e, n) {
            var i;
            return J(n) ? (e - t) / n : (i = n.asMonths(), Math.abs(i) >= 1 && pt(i) ? e.diff(t, "months", !0) / i : e.diff(t, "days", !0) / n.asDays())
        }

        function _(t, e) {
            var n, i;
            return J(t) || J(e) ? t / e : (n = t.asMonths(), i = e.asMonths(), Math.abs(n) >= 1 && pt(n) && Math.abs(i) >= 1 && pt(i) ? n / i : t.asDays() / e.asDays())
        }

        function Y(t, n) {
            var i;
            return J(t) ? e.duration(t * n) : (i = t.asMonths(), Math.abs(i) >= 1 && pt(i) ? e.duration({months: i * n}) : e.duration({days: t.asDays() * n}))
        }
        ...
        function U(t, e) {
            return t = W(t), e.start && (t.start = j(t.start, e)), e.end && (t.end = X(t.end, e.end)), t
        }

        function j(t, e) {
            return t = t.clone(), e.start && (t = K(t, e.start)), e.end && t >= e.end && (t = e.end.clone().subtract(1)), t
        }
        ...
        function yt(n, i, r) {
            ...
            return e.isMoment(u) || tt(u) || void 0 === u ? l = e.apply(null, n) : (s = !1, o = !1, c ? te.test(u) ? (u += "-01", n = [u], s = !0, o = !0) : (a = ee.exec(u)) && (s = !a[5], o = !0) : t.isArray(u) && (o = !0), l = i || s ? e.utc.apply(e, n) : e.apply(null, n), s ? (l._ambigTime = !0, l._ambigZone = !0) : r && (o ? l._ambigZone = !0 : c && l.utcOffset(u))), l._fullCalendar = !0, l
        }
        ...
        function wt(t, e) {
            var n;
            return st(e, "constructor") && (n = e.constructor), "function" != typeof n && (n = e.constructor = function () {
                t.apply(this, arguments)
            }), n.prototype = it(t.prototype), rt(e, n.prototype), rt(t, n), n
        }
        ...
        function Et(e) {
            ...
            if ("function" == typeof e && e(function (t) {
                    Et.immediate && (i._value = t), n.resolve(t)
                }, function () {
                    n.reject()
                }), Et.immediate) {
                var r = i.then;
                i.then = function (t, e) {
                    var n = i.state();
                    if ("resolved" === n) {
                        if ("function" == typeof t)return Et.resolve(t(i._value))
        ...
        function Dt(t) {
            ...
            var n = [];
            this.add = "number" == typeof t ? mt(e, t) : e, this.addQuickly = e
        }
        ...
        function At(t) {
            ...
            if (void 0 === t.forwardPressure) {
                for (e = 0; e < i.length; e++)n = i[e], At(n), r = Math.max(r, 1 + n.forwardPressure);
                t.forwardPressure = r
            }
        }
        ...
        function Pt(e, n) {
            ...
            function o(i) {
                ...
                return s && t.each(s.split(" "), function (n) {
                    ...
                    t.each(this.split(","), function (n, i) {
                        ...
                        "title" == i ? (s = s.add(t("<h2>&nbsp;</h2>")), o = !1) : ((r = (e.options.customButtons || {})[i]) ? (l = function (t) {
                            r.click && r.click.call(m[0], t)
                        }, u = "", c = r.text) : (a = e.getViewSpec(i)) ? (l = function () {
                            e.changeView(i)
                        }, v.push(i), u = a.buttonTextOverride, c = a.buttonTextDefault) : e[i] && (l = function () {
                            e[i]()
                        }, u = (e.overrides.buttonText || {})[i], c = e.options.buttonText[i]), l && (d = r ? r.themeIcon : e.options.themeButtonIcons[i], h = r ? r.icon : e.options.buttonIcons[i], f = u ? ut(u) : d && e.options.theme ? "<span class='ui-icon ui-icon-" + d + "'></span>" : h && !e.options.theme ? "<span class='fc-icon fc-icon-" + h + "'></span>" : ut(c), g = ["fc-" + i + "-button", p + "-button", p + "-state-default"], m = t('<button type="button" class="' + g.join(" ") + '">' + f + "</button>").click(function (t) {
                            m.hasClass(p + "-state-disabled") || (l(t), (m.hasClass(p + "-state-active") || m.hasClass(p + "-state-disabled")) && m.removeClass(p + "-state-hover"))
                        }).mousedown(function () {
            ...
            var f = this;
            f.setToolbarOptions = i, f.render = r, f.removeElement = s, f.updateTitle = a, f.activateButton = l, f.deactivateButton = u, f.disableButton = c, f.enableButton = d, f.getViewsWithButtons = h, f.el = null;
            var g, p, v = []
        }
        ...
        function _t(n, i) {
            ...
            function o() {
                n.addClass("fc"), n.on("click.fc", "a[data-goto]", function (e) {
                    var n = t(this), i = n.data("goto"), r = F.moment(i.date), s = i.type, o = P.opt("navLink" + ft(s) + "Click");
                ...
                var e = y();
                z = new Vt(e), A = F.header = e[0], G = F.footer = e[1], b(), E(), u(F.options.defaultView), F.options.handleWindowResize && (Y = mt(v, F.options.windowResizeDelay), t(window).resize(Y))
            }

            function a() {
                P && P.removeElement(), z.proxyCall("removeElement"), O.remove(), n.removeClass("fc fc-ltr fc-rtl fc-unthemed ui-widget"), n.off(".fc"), Y && t(window).unbind("resize", Y), ge.unneeded()
            }
            ...
            function u(e, n) {
                j++;
                var i = P && e && P.type !== e;
                i && (H(), c()), !P && e && (P = F.view = U[e] || (U[e] = F.instantiateView(e)), P.setElement(t("<div class='fc-view fc-" + e + "-view' />").appendTo(O)), z.proxyCall("activateButton", e)), P && l() && (n && P.captureInitialScroll(n), P.setDate(F.currentDate), F.currentDate = P.currentDate, n && P.releaseScroll()), i && R(), j--
            }
            ...
            function h(t) {
                if (l())return t && g(), j++, P.updateSize(!0), j--, !0
            }
            ...
            function H() {
                Z++ || O.css({width: "100%", height: O.height(), overflow: "hidden"})
            }

            function R() {
                --Z || O.css({width: "", height: "", overflow: ""})
            }
            ...
            var F = this;
            ge.needed(), F.render = s, F.destroy = a, F.rerenderEvents = m, F.select = D, F.unselect = T, F.zoomTo = C, F.getCalendar = x, F.getView = I, F.option = k, F.recordOptionOverrides = M, F.publiclyTrigger = B, F.dynamicOverrides = {}, F.viewSpecCache = {}, F.optionHandlers = {}, F.overrides = t.extend({}, i), F.populateOptionsHash();
            var N;
            F.bindOptions(["locale", "monthNames", "monthNamesShort", "dayNames", "dayNamesShort", "firstDay", "weekNumberCalculation"], function (t, e, n, i, s, o, a) {
                if ("iso" === a && (a = "ISO"), N = it(Wt(t)), e && (N._months = e), n && (N._monthsShort = n), i && (N._weekdays = i), s && (N._weekdaysShort = s), null == o && "ISO" === a && (o = 1), null != o) {
                    var l = it(N._week);
                    l.dow = o, N._week = l
                }
                "ISO" !== a && "local" !== a && "function" != typeof a || (N._fullCalendar_weekCalc = a), F.currentDate && r(F.currentDate)
                ...
                var t;
                return "local" === F.options.timezone ? (t = qt.moment.apply(null, arguments), t.hasTime() && t.local()) : t = "UTC" === F.options.timezone ? qt.moment.utc.apply(null, arguments) : qt.moment.parseZone.apply(null, arguments), r(t), t
            ...
            this.initCurrentDate(), F.renderView = u, F.getSuggestedViewHeight = function () {
                ...
                var t = F.getNow(), e = P.buildRangeInfo(t), n = P.buildPrevRangeInfo(F.currentDate), i = P.buildNextRangeInfo(F.currentDate);
                z.proxyCall(e.isValid && !q(t, P.currentRange) ? "enableButton" : "disableButton", "today"), z.proxyCall(n.isValid ? "enableButton" : "disableButton", "prev"), z.proxyCall(i.isValid ? "enableButton" : "disableButton", "next")
        ...
        function Ut() {
            ...
            function c(e, n) {
                f(e, function (i) {
                    ...
                    if (n === e._fetchId && "rejected" !== e._status) {
                        if (e._status = "resolved", i)for (r = 0; r < i.length; r++)s = i[r], o = a ? s : N(s, e), o && K.push.apply(K, _(o));
                        h()
                    }
                })
            }
            ...
            function f(e, n) {
                ...
                if (o)t.isFunction(o) ? (U.pushLoading(), o.call(U, j.clone(), q.clone(), U.options.timezone, function (t) {
                    ...
                    if (a) {
                        ...
                        var h = t.extend({}, l || {}), g = lt(e.startParam, U.options.startParam), p = lt(e.endParam, U.options.endParam), v = lt(e.timezoneParam, U.options.timezoneParam);
                        g && (h[g] = j.format()), p && (h[p] = q.format()), U.options.timezone && "local" != U.options.timezone && (h[v] = U.options.timezone), U.pushLoading(), t.ajax(t.extend({}, Re, e, {
                            data: h,
                            success: function (e) {
                                e = e || [];
            ...
            function N(n, i) {
                ...
                if (U.options.eventDataTransform && (n = U.options.eventDataTransform(n)), i && i.eventDataTransform && (n = i.eventDataTransform(n)), t.extend(a, n), i && (a.source = i), a._id = n._id || (void 0 === n.id ? "_fc" + xe++ : n.id + ""), n.className ? "string" == typeof n.className ? a.className = n.className.split(/\s+/) : a.className = n.className : a.className = [], r = n.start || n.date, s = n.end, et(r) && (r = e.duration(r)), et(s) && (s = e.duration(s)), n.dow || e.isDuration(r) || e.isDuration(s))a.start = r ? e.duration(r) : null, a.end = s ? e.duration(s) : null, a._recurring = !0; else {
                    ...
                    s && (s = U.moment(s), s.isValid() || (s = null)), o = n.allDay, void 0 === o && (o = lt(i ? i.allDayDefault : void 0, U.options.allDayDefault)), O(r, s, o, a)
                }
                return U.normalizeEvent(a), a
            }
            ...
            function _(e, n, i) {
                ...
                if (n = n || j, i = i || q, e)if (e._recurring) {
                    ...
                    for (a = n.clone().stripTime(); a.isBefore(i);)r && !r[a.day()] || (l = e.start, u = e.end, c = a.clone(), d = null, l && (c = c.time(l)), u && (d = a.clone().time(u)), h = t.extend({}, e), O(c, d, !l && !u, h), f.push(h)), a.add(1, "days")
                } else f.push(e);
                return f
            }
            ...
            function Y(e, n, i) {
                ...
                return n = n || {}, n.start || (n.start = e.start.clone()), void 0 === n.end && (n.end = e.end ? e.end.clone() : null), null == n.allDay && (n.allDay = e.allDay), V(n), s = {
                    ...
                    allDay: n.allDay
                }, V(s), o = null !== e._end && null === n.end, a = r(n.start, s.start), n.end ? (l = r(n.end, s.end), u = l.subtract(a)) : u = null, t.each(n, function (t, e) {
                    I(t) && void 0 !== e && (d[t] = e)
                }), c = W(B(e._id), o, n.allDay, a, u, d), {dateDelta: a, durationDelta: u, undo: c}
            }

            function W(e, n, i, r, s, o) {
                var a = U.getIsAmbigTimezone(), l = [];
                return r && !r.valueOf() && (r = null), s && !s.valueOf() && (s = null), t.each(e, function (e, u) {
                    ...
                    c = {
                        ...
                        allDay: i
                    }, V(d), n ? d.end = null : s && !d.end && (d.end = U.getDefaultEventEnd(d.allDay, d.start)), r && (d.start.add(r), d.end && d.end.add(r)), s && d.end.add(s), a && !d.allDay && (r || s) && (d.start.stripZone(), d.end && d.end.stripZone()), t.extend(u, o, d), jt(u), l.push(function () {
                        t.extend(u, c), jt(u)
                    })
                }), function () {
        ...
        var qt = t.fullCalendar = {version: "3.3.0", internalApiVersion: 8}, Zt = qt.views = {};
        ...
        qt.intersectRanges = N, qt.applyAll = at, qt.debounce = mt, qt.isInt = pt, qt.htmlEscape = ut, qt.cssToStr = dt, qt.proxy = vt, qt.capitaliseFirstLetter = ft, qt.getOuterRect = h, qt.getClientRect = f, qt.getContentRect = g, qt.getScrollbarWidths = p;
        var Qt = null;
        qt.preventDefault = H, qt.intersectRects = R, qt.parseFieldSpecs = L, qt.compareByFieldSpecs = M, qt.compareByFieldSpec = B, qt.flexibleCompare = F, qt.computeGreatestUnit = O, qt.divideRangeByDuration = P, qt.divideDurationByDuration = _, qt.multiplyDuration = Y, qt.durationHasTime = J;
        ...
        re.push("_fullCalendar"), re.push("_ambigTime"), re.push("_ambigZone"), qt.moment = function () {
            ...
            function n(t, e, n, s, o) {
                var a;
                return t = qt.moment.parseZone(t), e = qt.moment.parseZone(e), a = t.localeData(), n = a.longDateFormat(n) || n, i(r(n), t, e, s || " - ", o)
            }
            ...
            qt.formatDate = t, qt.formatRange = n, qt.oldMomentFormat = e, qt.queryMostGranularFormatUnit = f;
        ...
        var se = qt.formatDate, oe = qt.formatRange, ae = qt.oldMomentFormat;
        qt.Class = St, St.extend = function () {
            ...
            bt(this, t)
        }, qt.Promise = Et, Et.immediate = !0, Et.resolve = function (e) {
            ...
            var n, i, r, s = !1;
            if (Et.immediate)for (s = !0, n = [], i = 0; i < e.length; i++)if (r = e[i], r && "function" == typeof r.state && "resolved" === r.state() && "_value"in r)n.push(r._value); else {
        ...
        var le = qt.EmitterMixin = {
            ...
            startInteraction: function (e, n) {
                ...
                this.isInteracting || (n = n || {}, this.delay = lt(n.delay, this.options.delay, 0), this.minDistance = lt(n.distance, this.options.distance, 0), this.subjectEl = this.options.subjectEl, T(t("body")), this.isInteracting = !0, this.isTouch = D(e), this.isGeneric = "dragstart" === e.type, this.isDelayEnded = !1, this.isDistanceSurpassed = !1, this.originX = b(e), this.originY = E(e), this.scrollEl = d(t(e.target)), this.bindHandlers(), this.initAutoScroll(), this.handleInteractionStart(e), this.startDelay(e), this.minDistance || this.handleDistanceSurpassed(e))
            },
        ...
        he.mixin({
            ...
            initAutoScroll: function () {
                var t = this.scrollEl;
                this.isAutoScroll = this.options.scroll && t && !t.is(window) && !t.is(document), this.isAutoScroll && this.listenTo(t, "scroll", mt(this.handleDebouncedScroll, 100))
            },
            ...
            setScrollVel: function (t, e) {
                this.scrollTopVel = t, this.scrollLeftVel = e, this.constrainScrollVel(), !this.scrollTopVel && !this.scrollLeftVel || this.scrollIntervalId || (this.scrollIntervalId = setInterval(vt(this, "scrollIntervalFunc"), this.scrollIntervalMs))
            },
        ...
        var fe = he.extend({
            component: null, origHit: null, hit: null, coordAdjust: null, constructor: function (t, e) {
                ...
                this.component.hitsNeeded(), this.computeScrollBounds(), t ? (n = {
                    left: b(t),
                    top: E(t)
                }, i = n, r && (e = h(r), i = x(i, e)), this.origHit = this.queryHit(i.left, i.top), r && this.options.subjectCenter && (this.origHit && (e = R(this.origHit, e) || e), i = I(e)), this.coordAdjust = k(i, n)) : (this.origHit = null, this.coordAdjust = null), he.prototype.handleInteractionStart.apply(this, arguments)
            }, handleDragStart: function (t) {
                var e;
                he.prototype.handleDragStart.apply(this, arguments), e = this.queryHit(b(t), E(t)), e && this.handleHitOver(e)
            }, handleDrag: function (t, e, n) {
                var i;
                he.prototype.handleDrag.apply(this, arguments), i = this.queryHit(b(n), E(n)), Tt(i, this.hit) || (this.hit && this.handleHitOut(), i && this.handleHitOver(i))
                ...
                he.prototype.handleInteractionEnd.apply(this, arguments), this.origHit = null, this.hit = null, this.component.hitsNotNeeded()
            }, handleScrollEnd: function () {
                he.prototype.handleScrollEnd.apply(this, arguments), this.isDragging && (this.component.releaseHits(), this.component.prepareHits())
        ...
        var ge = St.extend(ue, le, {
            isTouching: !1, mouseIgnoreDepth: 0, handleScrollProxy: null, bind: function () {
                ...
                var t = this, e = qt.touchMouseIgnoreWait;
        ...
        var pe = St.extend(ue, {
            ...
            dayMousedown: function (t) {
                var e = this.view;
                ge.get().shouldIgnoreMouse() || (this.dayClickListener.startInteraction(t), e.opt("selectable") && this.daySelectListener.startInteraction(t, {distance: e.opt("selectMinDistance")}))
            },
            ...
            buildDaySelectListener: function () {
                var t, e = this, n = this.view, i = new fe(this, {
                    ...
                    hitOver: function (n, i, r) {
                        var o, a;
                        r && (o = e.getSafeHitSpan(r), a = e.getSafeHitSpan(n), t = o && a ? e.computeSelection(o, a) : null, t ? e.renderSelection(t) : t === !1 && s())
                    },
                    hitOut: function () {
            ...
            computeSelectionSpan: function (t, e) {
                ...
                return n.sort(gt), {start: n[0].clone(), end: n[3].clone()}
            },
            ...
            fillSegHtml: function (t, e) {
                var n = this[t + "SegClasses"], i = this[t + "SegCss"], r = n ? n.call(this, e) : [], s = dt(i ? i.call(this, e) : {});
                return "<" + this.fillSegTag + (r.length ? ' class="' + r.join(" ") + '"' : "") + (s ? ' style="' + s + '"' : "") + " />"
            },
            getDayClasses: function (t, e) {
                var n, i = this.view, r = [];
                return q(t, i.activeRange) ? (r.push("fc-" + Xt[t.day()]), 1 == i.currentRangeAs("months") && t.month() != i.currentRange.start.month() && r.push("fc-other-month"), n = i.calendar.getNow(), t.isSame(n, "day") ? (r.push("fc-today"), e !== !0 && r.push(i.highlightStateClass)) : t < n ? r.push("fc-past") : r.push("fc-future")) : r.push("fc-disabled-day"), r
            }
        });
        ve.mixin({
            ...
            buildBusinessHourEvents: function (e, n) {
                ...
                return null == n && (n = r.options.businessHours), i = r.computeBusinessHourEvents(e, n), !i.length && n && (i = [t.extend({}, Ie, {
            ...
            handleSegMouseover: function (t, e) {
                ge.get().shouldIgnoreMouse() || this.mousedOverSeg || (this.mousedOverSeg = t, this.view.isEventResizable(t.event) && t.el.addClass("fc-allow-mouse-resize"), this.view.publiclyTrigger("eventMouseover", t.el[0], t.event, e))
            },
            ...
            buildSegDragListener: function (t) {
                ...
                var c = this.segDragListener = new fe(a, {
                    ...
                    interactionStart: function (i) {
                        t.component = r, e = !1, n = new pe(t.el, {
                    ...
                    dragStart: function (n) {
                        c.isTouch && !a.isEventSelected(u) && a.selectEvent(u), e = !0, r.handleSegMouseout(t, n), r.segDragStart(t, n), a.hideEvent(u)
                    },
                    hitOver: function (e, o, l) {
                        var d, h, f, g = !0;
                        t.hit && (l = t.hit), d = l.component.getSafeHitSpan(l), h = e.component.getSafeHitSpan(e), d && h ? (i = r.computeEventDrop(d, h, u), g = i && r.isEventLocationAllowed(i, u)) : g = !1, g || (i = null, s()), i && (f = a.renderDrag(i, t)) ? (f.addClass("fc-dragging"), c.isTouch || r.applyDragOpacity(f), n.hide()) : n.show(), o && (i = null)
                    },
                    hitOut: function () {
            ...
            computeEventDrop: function (t, e, n) {
                ...
                return o.hasTime() === a.hasTime() ? (i = this.diffDates(a, o), n.allDay && J(i) ? (r = {
                    start: n.start.clone(),
                    end: s.getEventEnd(n),
                    allDay: !1
            ...
            buildSegResizeListener: function (t, e) {
                var n, i, r = this, a = this.view, l = a.calendar, u = t.el, c = t.event, d = l.getEventEnd(c), h = this.segResizeListener = new fe(this, {
                    scroll: a.opt("dragScroll"), subjectEl: u, interactionStart: function () {
                        n = !1
                    }, dragStart: function (e) {
                        n = !0, r.handleSegMouseout(t, e), r.segResizeStart(t, e)
                    }, hitOver: function (n, o, l) {
                        var u = !0, h = r.getSafeHitSpan(l), f = r.getSafeHitSpan(n);
                        h && f ? (i = e ? r.computeEventStartResize(h, f, c) : r.computeEventEndResize(h, f, c), u = i && r.isEventLocationAllowed(i, c)) : u = !1, u ? i.start.isSame(c.start.clone().stripZone()) && i.end.isSame(d.clone().stripZone()) && (i = null) : (i = null, s()), i && (a.hideEvent(c), r.renderEventResize(i, t))
                    }, hitOut: function () {
                        i = null, a.showEvent(c)
                    }, hitDone: function () {
                        r.unrenderEventResize(), o()
                    }, interactionEnd: function (e) {
                        n && r.segResizeStop(t, e), i ? a.reportSegResize(t, i, r.largeUnit, u, e) : a.showEvent(c),
            ...
            computeEventResize: function (t, e, n, i) {
                ...
                return r = {
                    ...
                    allDay: i.allDay
                }, r.allDay && J(a) && (r.allDay = !1, o.normalizeEventTimes(r)), r[t].add(a), r.start.isBefore(r.end) || (s = this.minResizeDuration || (i.allDay ? o.defaultAllDayEventDuration : o.defaultTimedEventDuration), "start" == t ? r.start = r.end.clone().subtract(s) : r.end = r.start.clone().add(s)), r
            },
            ...
            eventsToSegs: function (e, n) {
                ...
                return t.each(r, function (t, e) {
                    var r, o, a = [], l = [];
                    for (o = 0; o < e.length; o++)r = i.eventToRange(e[o]), r && (l.push(r), a.push(e[o]));
                    if (xt(e[0]))for (l = i.invertRanges(l), o = 0; o < l.length; o++)s.push.apply(s, i.eventRangeToSegs(l[o], e[0], n)); else for (o = 0; o < l.length; o++)s.push.apply(s, i.eventRangeToSegs(l[o], a[o], n))
                }), s
            },
        ...
        var me = qt.DayTableMixin = {
            ...
            sliceRangeByDay: function (t) {
                ...
                for (e = 0; e < this.rowCnt; e++)for (n = e * a, i = n + a - 1, r = n; r <= i; r++)s = Math.max(u, r), o = Math.min(c, r), s = Math.ceil(s), o = Math.floor(o), s <= o && d.push({
                    row: e,
            ...
            renderHeadDateCellHtml: function (t, e, n) {
                var i = this.view, r = q(t, i.activeRange), s = ["fc-day-header", i.widgetHeaderClass], o = ut(t.format(this.colHeadFormat));
                return 1 === this.rowCnt ? s = s.concat(this.getDayClasses(t, !0)) : s.push("fc-" + Xt[t.day()]), '<th class="' + s.join(" ") + '"' + (1 === (r && this.rowCnt) ? ' data-date="' + t.format("YYYY-MM-DD") + '"' : "") + (e > 1 ? ' colspan="' + e + '"' : "") + (n ? " " + n : "") + ">" + (r ? i.buildGotoAnchorHtml({
                    date: t,
            ...
            renderBgCellHtml: function (t, e) {
                var n = this.view, i = q(t, n.activeRange), r = this.getDayClasses(t);
            ...
            renderDates: function (t) {
                ...
                for (this.el.html(o), this.rowEls = this.el.find(".fc-row"), this.cellEls = this.el.find(".fc-day, .fc-disabled-day"), this.rowCoordCache = new de({
                    els: this.rowEls,
                    isVertical: !0
        ...
        ye.mixin({
            rowStructs: null, unrenderEvents: function () {
                this.removeSegPopover(), ve.prototype.unrenderEvents.apply(this, arguments)
            }, getEventSegs: function () {
            ...
            segPopover: null, popoverSegs: null, removeSegPopover: function () {
                ...
                if (n && n < w.segLevels.length) {
                    for (r = w.segLevels[n - 1], s = w.cellMatrix, o = w.tbodyEl.children().slice(n).addClass("fc-limited").get(), a = 0; a < r.length; a++) {
                        for (l = r[a], i(l.leftCol), d = [], c = 0; E <= l.rightCol;)u = this.getCellSegs(e, E, n), d.push(u), c += u.length, E++;
                        if (c) {
                            for (h = s[n - 1][l.leftCol], f = h.attr("rowspan") || 1, g = [], p = 0; p < d.length; p++)v = t('<td class="fc-more-cell"/>').attr("rowspan", f), u = d[p], y = this.renderMoreLink(e, l.leftCol + p, [l].concat(u)), m = t("<div/>").append(y), v.append(m), g.push(v[0]), b.push(v[0]);
                ...
                }, this.isRTL ? s.right = l.offset().left + l.outerWidth() + 1 : s.left = l.offset().left - 1, this.segPopover = new ce(s), this.segPopover.show(), this.bindSegHandlersToEl(this.segPopover.el)
        ...
        var Se = qt.TimeGrid = ve.extend(me, {
            ...
            constructor: function () {
                ve.apply(this, arguments), this.processOptions()
            },
            renderDates: function () {
                this.el.html(this.renderHtml()), this.colEls = this.el.find(".fc-day, .fc-disabled-day"), this.slatContainerEl = this.el.find(".fc-slats"), this.slatEls = this.slatContainerEl.find("tr"), this.colCoordCache = new de({
                    els: this.colEls,
                    isHorizontal: !0
            ...
            computeLabelInterval: function (t) {
                var n, i, r;
                for (n = Ae.length - 1; n >= 0; n--)if (i = e.duration(Ae[n]), r = _(i, t), pt(r) && r > 1)return i;
                return e.duration(t)
            },
            computeEventTimeFormat: function () {
        ...
        Se.mixin({
            ...
            computeFgSegHorizontals: function (t) {
                var e, n, i;
                if (this.sortEventSegs(t), e = Nt(t), zt(e), n = e[0]) {
                    for (i = 0; i < n.length; i++)At(n[i]);
        ...
        var we = qt.View = St.extend(le, ue, {
            ...
            constructor: function (t, n) {
                this.calendar = t, this.viewSpec = n, this.type = n.type, this.options = n.options, this.name = this.type, this.nextDayThreshold = e.duration(this.opt("nextDayThreshold")),
                    this.initThemingProps(), this.initHiddenDays(), this.isRTL = this.opt("isRTL"), this.eventOrderSpecs = L(this.opt("eventOrder")), this.dateRenderQueue = new Dt, this.eventRenderQueue = new Dt(this.opt("eventRenderWait")), this.initialize()
            },
            initialize: function () {
            },
            opt: function (t) {
            ...
            formatRange: function (t, e, n) {
                var i = t.end;
                return i.hasTime() || (i = i.clone().subtract(1)), oe(t.start, i, e, n, this.opt("isRTL"))
            },
            ...
            buildGotoAnchorHtml: function (e, n, i) {
                var r, s, o, a;
                return t.isPlainObject(e) ? (r = e.date, s = e.type, o = e.forceOff) : r = e, r = qt.moment(r), a = {
                    date: r.format("YYYY-MM-DD"),
                    type: s || "day"
                }, "string" == typeof n && (i = n, n = null), n = n ? " " + ht(n) : "", i = i || "", !o && this.opt("navLinks") ? "<a" + n + ' data-goto="' + ut(JSON.stringify(a)) + '">' + i + "</a>" : "<span" + n + ">" + i + "</span>"
            },
            setElement: function (t) {
            ...
            executeDateRender: function (t) {
                var e = this, n = !1;
                return t && (n = e.setRangeFromDate(t)), t && !n && e.isDateRendered ? Et.resolve() : (t ? this.captureInitialScroll() : this.captureScroll(), this.freezeHeight(), this.executeDateUnrender().then(function () {
            ...
            executeEventsUnrender: function () {
                return this.isEventsRendered && (this.onBeforeEventsUnrender(), this.captureScroll(), this.freezeHeight(), this.destroyEvents && this.destroyEvents(), this.unrenderEvents(), this.thawHeight(), this.releaseScroll(), this.isEventsRendered = !1, this.trigger("eventsUnrender")), Et.resolve()
            },
        ...
        we.mixin({
            ...
            buildRangeInfo: function (t, n) {
                ...
                return i = this.buildCurrentRangeInfo(l, n), r = this.buildRenderRange(i.range, i.unit), s = W(r), this.opt("showNonCurrentDates") || (s = U(s, i.range)), u = e.duration(this.opt("minTime")), c = e.duration(this.opt("maxTime")), this.adjustActiveRange(s, u, c), s = U(s, a), l = j(l, s), o = q(t, i.range) && Z(i.range, a), {
                    validRange: a,
            ...
            buildRangeFromDuration: function (t, e, n, i) {
                ...
                return n.as("days") <= 1 && this.isHiddenDay(o) && (o = this.skipHiddenDays(o, e), o.startOf("day")), o.startOf(s || i), r = o.clone().add(n), {
                    start: o,
                    end: r
                }
            },
        ...
        var Ee = qt.Calendar = St.extend({
            ...
            buildViewSpec: function (t) {
                for (var i, r, s, o, a, l = this.overrides.views || {}, u = [], c = [], d = [], h = t; h;)i = Zt[h], r = l[h], h = null, "function" == typeof i && (i = {class: i}), i && (u.unshift(i), c.unshift(i.defaults || {}), s = s || i.duration, h = h || i.type), r && (d.unshift(r), s = s || r.duration, h = h || r.type);
                return i = nt(u), i.type = t, !!i.class && (s = s || this.dynamicOverrides.duration || this.overrides.duration, s && (o = e.duration(s), o.valueOf() && (a = O(o), "week" === a && "object" == typeof s && s.days && (a = "day"), i.duration = o, i.durationUnit = a, 1 === o.as(a) && (i.singleUnit = a, d.unshift(l[a] || {})))), i.defaults = n(c), i.overrides = n(d), this.buildViewSpecOptions(i), this.buildViewSpecButtonText(i, t), i)
            },
            buildViewSpecOptions: function (t) {
                t.options = n([Ee.defaults, t.defaults, this.dirDefaults, this.localeDefaults, this.overrides, t.overrides, this.dynamicOverrides]), Yt(t.options)
            },
        ...
        qt.datepickerLocale = function (e, n, i) {
            var r = De[e] || (De[e] = {});
            r.isRTL = i.isRTL, r.weekNumberTitle = i.weekHeader, t.each(Te, function (t, e) {
                r[t] = e(i)
            ...
            var r, s;
            r = De[e] || (De[e] = {}), i && (r = De[e] = n([r, i])), s = Wt(e), t.each(Ce, function (t, e) {
                null == r[t] && (r[t] = e(s, r))
        ...
        qt.locale("en", Ee.englishDefaults), qt.sourceNormalizers = [], qt.sourceFetchers = [];
        var Re = {dataType: "json", cache: !1}, xe = 1;
        Ee.prototype.mutateSeg = function (t, e) {
            ...
            var n = e.source || {}, i = lt(e.constraint, n.constraint, this.options.eventConstraint), r = lt(e.overlap, n.overlap, this.options.eventOverlap);
            ...
            for (o = this.getPeerEvents(t, i), a = 0; a < o.length; a++)if (l = o[a], this.eventIntersectsRange(l, t)) {
                ...
                if (i) {
                    if (u = lt(l.overlap, (l.source || {}).overlap), u === !1)return !1;
        ...
        Ee.prototype.getCurrentBusinessHourEvents = function (t) {
            ...
            for (r = 0; r < n.length; r++)s = n[r], i && !s.dow || (s = t.extend({}, Ie, s), e && (s.start = null, s.end = null), a.push.apply(a, this.expandEvent(this.buildEventFromInput(s), o.activeRange.start, o.activeRange.end)));
            return a
        };
        ...
        Zt.basic = {class: ke}, Zt.basicDay = {type: "basic", duration: {days: 1}}, Zt.basicWeek = {
            type: "basic",
            duration: {weeks: 1}
        }, Zt.month = {class: Me, duration: {months: 1}, defaults: {fixedWeekCount: !0}};
        var Be = qt.AgendaView = we.extend({
            ...
            setHeight: function (t, e) {
                var n, s, o;
                this.bottomRuleEl.hide(), this.scroller.clear(), r(this.noScrollRowEls), this.dayGrid && (this.dayGrid.removeSegPopover(), n = this.opt("eventLimit"), n && "number" != typeof n && (n = ze), n && this.dayGrid.limitRows(n)), e || (s = this.computeScrollerHeight(t), this.scroller.setHeight(s), o = this.scroller.getScrollbarWidths(), (o.left || o.right) && (i(this.noScrollRowEls, o), s = this.computeScrollerHeight(t), this.scroller.setHeight(s)), this.scroller.lockOverflow(o), this.timeGrid.getTotalSlatHeight() < s && this.bottomRuleEl.show())
            },
            computeScrollerHeight: function (t) {
                return t - c(this.el, this.scroller.el)
            },
        ...
        }, ze = 5, Ae = [{hours: 1}, {minutes: 30}, {minutes: 15}, {seconds: 30}, {seconds: 15}];
        Zt.agenda = {
            class: Be,
        ...
        var Ge = we.extend({
            grid: null, scroller: null, initialize: function () {
                this.grid = new Oe(this), this.scroller = new be({overflowX: "hidden", overflowY: "auto"})
            }, renderSkeleton: function () {
            ...
            segSelector: ".fc-list-item", hasDayInteractions: !1, spanToSegs: function (t) {
                ...
                var i;
                ve.prototype.handleSegClick.apply(this, arguments), t(n.target).closest("a[href]").length || (i = e.event.url, i && !n.isDefaultPrevented() && (window.location.href = i))
            }, renderFgSegs: function (t) {
                ...
                return '<tr class="fc-list-heading" data-date="' + t.format("YYYY-MM-DD") + '"><td class="' + e.widgetHeaderClass + '" colspan="3">' + (n ? e.buildGotoAnchorHtml(t, {class: "fc-list-heading-main"}, ut(t.format(n))) : "") + (i ? e.buildGotoAnchorHtml(t, {class: "fc-list-heading-alt"}, ut(t.format(i))) : "") + "</td></tr>"
                ...
                return e = s.allDay ? n.getAllDayHtml() : n.isMultiDayEvent(s) ? t.isStart || t.isEnd ? ut(this.getEventTimeText(t)) : n.getAllDayHtml() : ut(this.getEventTimeText(s)), o && i.push("fc-has-url"), '<tr class="' + i.join(" ") + '">' + (this.displayEventTime ? '<td class="fc-list-item-time ' + n.widgetContentClass + '">' + (e || "") + "</td>" : "") + '<td class="fc-list-item-marker ' + n.widgetContentClass + '"><span class="fc-event-dot"' + (r ? ' style="background-color:' + r + '"' : "") + '></span></td><td class="fc-list-item-title ' + n.widgetContentClass + '"><a' + (o ? ' href="' + ut(o) + '"' : "") + ">" + ut(t.event.title || "") + "</a></td></tr>"
            }
        });
        return Zt.list = {
            class: Ge,
