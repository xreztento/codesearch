        ...
        $.widget("moogle.contextmenu", {
            ...
            _create: function () {
                ...
                if (opts.preventSelect) {
                   ...
                   if(typeof opts.delegate == "string"){
                    ...
                    if (supportSelectstart) {
                        if(typeof opts.delegate == "string"){
                            ...
                            this.element.on("selectstart" + this.eventNamespace,
                                function (event) {
                                    event.preventDefault();
                                });
                        }
                ...
                if(typeof opts.delegate == "string"){
                    ...
                    this.element.on(eventNames, $.proxy(this._openMenu, this));
            ...
            createMenuMarkup: function (options, $parentUl) {
                ...
                for (i = 0; i < options.length; i++) {
                    ...
                    if ($.isArray(menu.children)) {
                        //xreztento
                        $ul = $("<ul/>").css("width","200px").appendTo($li);
