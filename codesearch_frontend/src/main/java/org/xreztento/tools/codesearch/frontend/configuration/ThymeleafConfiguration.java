package org.xreztento.tools.codesearch.frontend.configuration;
...
public class ThymeleafConfiguration {
    ...
    private final static String JS_PLUGIN_CLASSPATH = "/static/js/plugin";
    private final static String TEMPLATE_PLUGIN_CLASSPATH = "/templates/plugin";
    private final static String CSS_PLUGIN_CLASSPATH = "/static/css/plugin";
    ...
    public ThymeleafViewResolver thymeleafViewResolver() {
        ...
        resolver.setContentType(appendCharset(this.properties.getContentType().toString(), resolver.getCharacterEncoding()));
    ...
    private void includePluginStatics(Map<String, Object> staticVaribales) {
        try {
            ...
            staticVaribales.put("cssPluginFiles", getAllFileNameByFolder(CSS_PLUGIN_CLASSPATH, "css"));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
