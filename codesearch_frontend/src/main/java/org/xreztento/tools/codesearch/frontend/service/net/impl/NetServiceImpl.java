package org.xreztento.tools.codesearch.frontend.service.net.impl;
...
import org.xreztento.tools.codesearch.frontend.exception.BadRequestException;
import org.xreztento.tools.codesearch.frontend.exception.InternalException;
import org.xreztento.tools.codesearch.frontend.exception.NoLoginException;
import org.xreztento.tools.codesearch.frontend.exception.NoPermissionException;
import org.xreztento.tools.codesearch.frontend.exception.ResourceNotFoundException;
...
public class NetServiceImpl implements NetService {
   ...
   @Override
	public <T> T getForObjectWithoutAuth(String uri, Class<T> returnType) throws RestClientException {
		 String url = getUrl(uri);
		    HttpHeaders headers = getHeadertWithoutAuth();
		    logger.info(url);
    ...
    public <T> T deleteForObject(String uri, Class<T> returnType) throws RestClientException {
     ...
     private HttpHeaders getHeadertWithoutAuth() {
